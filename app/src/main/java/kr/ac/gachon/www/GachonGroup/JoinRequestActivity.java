...
public class JoinRequestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        helper.setEditText("StudentNumber", ID, student_numberET);
        helper.setEditText("major", ID, majorET);
    ...
    private void JoinRequest() {
        ...
        if(name.length()==0) Toast.makeText(JoinRequestActivity.this, "이름을 입력해 주세요", Toast.LENGTH_SHORT).show();
            ...
            JoinRequest joinRequest=new JoinRequest(name, contact, student_number, major, age, self_introduce, ID);
            helper.MakeJoinRequest(joinRequest, groupName, JoinRequestActivity.this);
        }
